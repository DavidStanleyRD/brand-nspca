...
$middle_column_background_colour = get_field('middle_column_background_colour');
$middle_column_text_colour       = get_field('middle_column_text_colour');
...
<section <?php if (!empty($block['anchor'])): ?> id="<?= esc_attr($block['anchor']); ?>" <?php endif; ?> class="section section-<?= $randomString; ?>">
    ...
    <div class="wrapper <?= $padding_top; ?> <?= $padding_bottom; ?>">
        ...
        <div class="row three-columns <?= $verticalAlignment; ?>">

            <div class="col-xs-12 col-md-4 fade_in">
            ...
            <div class="col-xs-12 col-md-4 fade_in">
                <?php if (have_rows('middle_column')): ?>
                    <?php $wrapper_attrs = column_wrapper_attrs($middle_column_background_colour, $middle_column_text_colour, $column_border_radius); ?>
                    <?php if ($wrapper_attrs): ?><div<?= $wrapper_attrs; ?>><?php endif; ?>
